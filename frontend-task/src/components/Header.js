    ...
    <div>
      ...
      <main>
        ...
        <span className="text-sm cursor-pointer ml-6 font-body">
           Administration <span className="ml-1"><FontAwesomeIcon icon={faAngleDown} /></span> </span>
            <span className="text-sm cursor-pointer font-body"> Inventory
               <span className="ml-1"><FontAwesomeIcon icon={faAngleDown} /></span> </span>
        </div>
      </main>
    </div>
  );
